...
function JollyDatePicker<T extends AriaDateValue>({
  ...
  return (
    ...
    >
      <Label>{label}</Label>
      <AriaGroup className="flex h-10 w-full items-center overflow-hidden rounded-xl border border-input bg-background px-3 py-2 text-sm ring-offset-background transition-all duration-200 data-[focus-within]:outline-none data-[focus-within]:ring-2 data-[focus-within]:ring-ring data-[focus-within]:ring-offset-2">
        <DateInput className="flex-1" variant="ghost" />
        <AriaButton className="mr-1 flex size-6 items-center justify-center rounded-md data-[focus-visible]:ring-offset-0">
